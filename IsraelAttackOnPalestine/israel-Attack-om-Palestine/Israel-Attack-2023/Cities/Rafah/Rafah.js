   const headlines = [
    "BeitRafah was plunged into turmoil following an Israeli Attack on November 25, 2023, marking a dark period for the city...",
    "The city endured significant loss, with twenty men, sixteen women, and twelve children tragically losing their lives. Despite the adversity, Rafah's population of 30,000 stands resilient, united in their determination to rebuild and overcome the challenges they face."
  ];
  let currentIndex = 0;
  let wordIndex = 0;
  let isAdding = true;
