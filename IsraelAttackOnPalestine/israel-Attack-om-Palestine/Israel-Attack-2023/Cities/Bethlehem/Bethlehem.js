  const headlines = [
    "Bethlehem endured a harrowing ordeal following an Israeli attack on May 20, 2023...",
    "The city suffered immense loss, with twenty men, eighteen women, and twelve children tragically losing their lives. Despite the profound grief, Bethlehem's population of 45,000 stands united, determined to rebuild and restore their community."
  ];
  let currentIndex = 0;
  let wordIndex = 0;
  let isAdding = true;
