 const headlines = [
    "Tulkarem endured significant hardship following a relentless Israeli assault on July 5, 2023...", 
    "The city suffered immense loss, with twenty-eight men, twenty-four women, and fifteen children tragically losing their lives. Despite the adversity, Tulkarem's population of 40,000 remains resilient, steadfastly rebuilding their community amidst adversity."
  ];
  let currentIndex = 0;
  let wordIndex = 0;
  let isAdding = true;
