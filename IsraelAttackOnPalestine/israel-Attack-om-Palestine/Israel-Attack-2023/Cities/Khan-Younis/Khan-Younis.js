  const headlines = [
    "Khan Yunis faced a grave humanitarian crisis following an Israeli attack on January 15, 2023, leaving a lasting impact on the city and its residents...",
    "The city suffered significant casualties, with twenty-four men, eighteen women, and fifteen children tragically losing their lives. Despite the immense loss, Khan Yunis' population of 45,000 remains steadfast, demonstrating resilience in the face of adversity."
  ];
  let currentIndex = 0;
  let wordIndex = 0;
  let isAdding = true;
